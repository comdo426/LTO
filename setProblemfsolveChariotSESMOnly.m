function [Problem, State] = setProblemfsolveChariotSESMOnly(System, State, Spacecraft, Option, ...
	Collocation)
...
Problem.objective = @(x) fsolveConstraintChariotSESMOnly(x, System, State, Spacecraft, ...
	Option, Collocation);
