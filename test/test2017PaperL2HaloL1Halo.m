...
% TEST: L2 Halo to L1 Halo atd. use Phase 1: s = 25, nRev =
% 2, Phase 2: s = 25, nRev = 2 to get the same figures in the example folder

Setup.Phase{1,1}.orbitSource = 'atd';
Setup.Phase{2,1}.orbitSource = 'atd';
Setup.Phase{1,1}.orbitName = 'Halo_L2';
Setup.Phase{1,1}.orbitSelect = {'JC', 3.0275};
Setup.Phase{2,1}.orbitName = 'Halo_L1';
Setup.Phase{2,1}.orbitSelect = {'JC', 3.0275};

Setup.Phase{1,1}.s = 25; % Number of segments per rev
Setup.Phase{1,1}.nRev = 2; % Total rev for the orbit stack
Setup.Phase{2,1}.s = 25;
