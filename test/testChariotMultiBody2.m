...
InitialGuess{3}.finalConstraint = InitialGuess{3}.state(end, 1:6)';
...
Option.ipoptopt.ipopt.max_iter = 300000;
...
Option.ipoptopt.ipopt.bound_frac = 1e-16;
% How relaxed the bounds are going to be during the optimization
Option.ipoptopt.ipopt.bound_relax_factor = 1e-8;
...
Option.posBoundary = 0.01; % n.d.;
Option.velBoundary = 0.01; % n.d.;
Option.aopBoundary = 1; % rad;
Option.mfBoundary = 0.001; % n.d.
...
%% Calls LTOMain
Result = LTOMainChariot2(System, InitialGuess, Spacecraft, Option);
