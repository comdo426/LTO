function [Problem, State] = setProblemfsolveChariotSEOnly(System, State, Spacecraft, Option, ...
	Collocation)
...
Problem.objective = @(x) fsolveConstraintChariotSEOnly(x, System, State, Spacecraft, ...
	Option, Collocation);
