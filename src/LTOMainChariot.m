function [State, aop, mf, tSpiral] = LTOMainChariot(System, State, Spacecraft, Option)
...
while isFeasible && ~Option.doneFeasible
	...
	[Problem, State] = setProblemfsolveChariot(System, State, Spacecraft, Option, ...
		Collocation);
...
while isOptimize && ~Option.doneOptimize
	...
	[x0, funcs, options, State] = setProblemipoptChariot(System, State, Spacecraft, Option, Collocation);
