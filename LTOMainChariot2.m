function [State, aop, mf] = LTOMainChariot2(System, State, Spacecraft, Option)
...
while isFeasible && ~Option.doneFeasible
	...
	[Problem, State] = setProblemfsolveChariot2(System, State, Spacecraft, Option, ...
		Collocation);
...
while isOptimize && ~Option.doneOptimize
	...
	[x0, funcs, options, State] = setProblemipoptChariot2(System, State, Spacecraft, Option, Collocation);
